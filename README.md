...
3. L'exécutable sera dans le dossier `dist\Project-texture-cleaner.exe`
...
# L'exécutable sera dans dist\Project-texture-cleaner.exe
```

## 🚀 Utilisation

### Lancer l'application
- Double-cliquez sur `Project-texture-cleaner.exe`
